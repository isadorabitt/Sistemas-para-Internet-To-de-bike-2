  ...
  return (
    <main className={registerForm.loginMain}>
      ...
      <form className={registerForm.form}>
        ...
        />
        <label>{error}</label>
        <Button onClick={handleLogin} primary="true" round="true">
          Entrar
        </Button>
      </form>

      <footer className={registerForm.foot}>
        Não tem uma conta?{" "}
        <a className={registerForm.link} href={"/cadastro"}>
